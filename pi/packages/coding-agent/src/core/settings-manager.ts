...
export interface CompactionSettings {
	enabled?: boolean; // default: false in JARVIS Code
...
export interface Settings {
	...
	enableInstallTelemetry?: boolean; // default: false in JARVIS Code
	...
	doubleEscapeAction?: "fork" | "tree" | "none"; // Action for double-escape with empty editor (default: "none" in JARVIS Code)
...
export class SettingsManager {
	...
	setDefaultThinkingLevel(_level: "off" | "minimal" | "low" | "medium" | "high" | "xhigh" | "max" | "ultra"): void {
		this.globalSettings.defaultThinkingLevel = DEFAULT_THINKING_LEVEL;
	...
	getDoubleEscapeAction(): "fork" | "tree" | "none" {
		return this.settings.doubleEscapeAction ?? "none";
	}
