...
**macOS · Linux** (베타/basic 지원) — POSIX shell에서:
...
Windows는 `%LOCALAPPDATA%\JARVIS-Code`, macOS/Linux는
`$HOME/.local/share/jarvis-code` 아래 설치. 새 머신 기준 대략 용량:
...
| 전제조건 (Node 20+, npm, Python 3.10+, Git, Windows의 MSVC) — *없을 때만* | ~0.5 GB |
